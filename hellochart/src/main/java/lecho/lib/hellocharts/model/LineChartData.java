...
public class LineChartData extends AbstractChartData {
    public static final float DEFAULT_BASE_VALUE = 0.0f;//单精度浮点数0

    private List<Line> lines = new ArrayList<Line>();//线条堆积
    private float baseValue = DEFAULT_BASE_VALUE;//基本值，默认基本值
    ...
    public static LineChartData generateDummyData() {//产生样品数据
        final int numValues = 4;
        LineChartData data = new LineChartData();//产生对象
