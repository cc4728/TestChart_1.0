...
public class PointValue {
    ...
    public PointValue() {//构造方法，无参
        set(0, 0);
    }//构造方法

    public PointValue(float x, float y) {//有参数构造方法
        set(x, y);
    }//构造方法
    ...
    public void update(float scale) {//更新的方法
    ...
    @Deprecated
    public char[] getLabel() {//返回一个字节数组，显示label
        return label;
    }
    ...
    @Override
    public String toString() {//将数据f转化为字符串
